...
namespace PortalGame.PortalSystem {
    ...
    public class Portal : MonoBehaviour {
        ...
        public void PrePortalRender(ScriptableRenderContext ctx) {
            Debug.Log($"Portal {name} PreRender");
        ...
        public void Render(ScriptableRenderContext ctx) {
            ...
            for (int i = startIndex; i < recursionLimit; i++) {
                ...
                SetNearClipPlane();
                HandleClipping();
                UniversalRenderPipeline.SubmitRenderRequest(portalCam, new UniversalRenderPipeline.SingleCameraRequest());
        ...
        public void PostPortalRender(ScriptableRenderContext ctx) {
            Debug.Log($"Portal {name} PostRender");
        ...
        void OnTriggerExit(Collider other) {
            if (other.TryGetComponent<PortalTraveller>(out var traveller) && trackedTravellers.Contains(traveller)) {
